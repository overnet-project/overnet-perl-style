...
SIBLING_LIBS=()
INSTALL_DISTS=(overnet-perl-style)
NEED_NOSTR_CORE=0   # dists that pull Net::Nostr need this installed first
NEED_STYLE=0        # install overnet-perl-style tooling for xt/author checks
# ---------------------------------------------------------------------------
